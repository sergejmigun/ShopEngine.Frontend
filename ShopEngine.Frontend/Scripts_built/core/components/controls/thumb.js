app.registerComponent('thumb', 'UI', [
    ...
    function ($, promise, urls, eventsInitializer) {
        'use strict';
        return {
            init: function (container, initData) {
                var control = {}, _$wrapper = $('<a class="pointer thumbnail no-margin-b" />'), _$img = $('<img style="max-height: 70px;" />'), _events = eventsInitializer.init(control, ['click']);
