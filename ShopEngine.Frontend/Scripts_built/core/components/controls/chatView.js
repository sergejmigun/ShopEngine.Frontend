app.registerComponent('chatView', 'UI', [
    ...
    function (promise, objects, collections, eventsInitializer, chatViewUiContext) {
        'use strict';
        return {
            init: function (container, initData) {
                var _uiContext, _messages = [];
                var _events = {
                    onMessageSubmit: eventsInitializer.initEvent()
                };
                var _control = {
                    ...
                    addMessage: function (messageData) {
                        ...
                        var prev = _messages[targetIndex - 1], next = _messages[targetIndex + 1];
                        _messages.push();
                ...
                function init(success) {
                    ...
                    chatViewUiContext.init(container, uiContextInitData).then(function (uiContext) {
