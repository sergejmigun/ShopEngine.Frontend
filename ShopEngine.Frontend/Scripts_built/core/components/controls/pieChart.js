...
app.registerComponent('pieChart', 'UI', [
    ...
    'Utils.strings',
    function ($, promise, objects, colors, collections, eventsInitializer, chartHelper, strings) {
        'use strict';
        return {
            init: function (container, initData) {
                var control = {}, _$wrapper = $('<div class="chart-wrapper" />'), _$canvas = $('<canvas id="myChart" />'), _$legend = $('<div class="legend-wrapper" />'), _total = 0, _pieChart, _events = eventsInitializer.init(control, ['renderComplete', 'click']);
