    ...
    function ($, promise, collections, eventsInitializer) {
        ...
        return {
            init: function (container, initData) {
                var control = {}, _$wrapper = $('<div />'), _events = eventsInitializer.init(control, ['itemClick']);
                function initClick($item, item) {
                ...
                function buildDropDownToggleButton() {
                    var customHtml = '<a data-toggle="dropdown" />', defaultHtml = '<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" data-placement="top">' +
                ...
                function buildMenu($wrapper, items) {
                    function buildItem($wrapper, item) {
                        var $itemWrapper = $('<li role="menuitem" />'), $itemButton = $('<a href="#" />');
                        if (item.url) {
