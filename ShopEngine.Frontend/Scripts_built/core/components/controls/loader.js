app.registerComponent('loader', 'UI', ['$', 'Promise', function ($, promise) {
        'use strict';
        return {
            ...
            initOverlay: function ($container) {
                var control = {}, _$overlay;
                function getOverlay() {
                    var $overlay = $('<div class="loading-overlay" />'), $overlayInner = $('<div class="loading-overlay-inner" />'), $span = $('<span class="loading-spinner" />');
