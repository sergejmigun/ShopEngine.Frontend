app.registerComponent('gridView', 'Components', [
    ...
    'UI.fixedArea',
    'UI.loader',
    function ($, promise, templates, resources, collections, urls, objects, services, containerHelper, dropDownMenu, pagination, singleSelectList, searchBox, fixedArea, loader) {
        'use strict';
        return {
            init: function (model, container) {
                var template = {}, _$html, _loader, _pagination, _$gridViewContainer, _$gridFilterContainer, _$gridFilter, _$gridGlobalActions, _$gridViewTitle, _$gridViewInfo, _$gridPageSizeWrapper, _$gridSearchWrapper, _$gridWrapper, _$pagingWrapper, _fetchingData = {
                ...
                function displayFetchingInfo(fetchingData) {
                    ...
                    if (fetchingData.total === 0) {
                        ...
                        var $span = $('<span />'), from = (fetchingData.requestData.page - 1) * fetchingData.requestData.pageSize + 1, to = fetchingData.requestData.page * fetchingData.requestData.pageSize;
                ...
                function fetch() {
                    _loader.show();
                    var requestData = objects.clone(_fetchingData.requestData), filterData = _fetchingData.requestData.filterData;
                ...
                function fetchInitial() {
                    ...
                    return promise.create(function (success) {
                        fetch().then(function (responseData) {
                            ...
                            model.gridTemplateFactory.init(responseData, containerHelper.appendTo(_$gridWrapper, container.ready())).then(function (gridTemplate) {
                                template.grid = gridTemplate;
                                template.grid.onChangeOrder(function (orderData) {
                                    _fetchingData.requestData.orderData = collections.from(orderData).select(function (orderDataItem) {
                                        return {
                ...
                function initGlobalActions() {
                    ...
                    dropDownMenu.init(containerHelper.appendTo(_$gridGlobalActions, container.ready()), {
                        ...
                        items: collections.from(model.actions).skip(1).toArray(),
