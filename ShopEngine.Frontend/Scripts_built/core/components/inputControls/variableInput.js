app.registerComponent('variableInput', 'UI', [
    ...
    'UI.itemsSwitcher',
    function ($, promise, collections, objects, defaultInputValidationHandler, eventsInitializer, containerHelper, itemsSwitcher) {
        'use strict';
        return {
            init: function (container, initData) {
                var control = {}, _$wrapper, _$variablesListWrapper, _variationsData = {}, _currentVariation, _input, _variationPicker, _$inputWrapper, _ignoreChange, _validationHandler = defaultInputValidationHandler.init(control), _events = eventsInitializer.init(control, ['onChange', 'onRemove']);
                ...
                function init(success) {
                    ...
                    var inputPromise = initInput(), ddPromise = initSwitcher(listItems);
