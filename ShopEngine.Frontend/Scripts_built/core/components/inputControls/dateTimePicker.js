app.registerComponent('dateTimePicker', 'UI', [
    ...
    'Utils.objects',
    'Utils.dates',
    function ($, promise, eventsInitializer, defaultInputValidationHandler, objects, dates) {
        'use strict';
        return {
            init: function (container, initData) {
                var control = {}, _$wrapper, _$controlWrapper, _$readOnlyLabel, _$control, _format, _value, _validationHandler = defaultInputValidationHandler.init(control), _events = eventsInitializer.init(control, ['onChange', 'onRemove']);
                ...
                function init(success) {
                    ...
                    _$control.on("dp.change", function (e) {
