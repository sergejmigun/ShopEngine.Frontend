    ...
    function ($, promise, defaultInputValidationHandler, eventsInitializer, objects) {
        ...
        return {
            init: function (container, initData) {
                var control = {}, _$wrapper, _$controlWrapper, _$readOnlyArea, _$control, _tinyMceEditor, _tinyMceEditorId, _readOnly, _disabled, _toolbar = 'insertfile undo redo | bold italic | alignleft aligncenter alignright alignjustify | bullist | forecolor backcolor', _validationHandler = defaultInputValidationHandler.init(control), _events = eventsInitializer.init(control, ['onChange', 'onRemove']);
