app.registerComponent('rangeNumericBox', 'UI', [
    ...
    'UI.numericBox',
    'UI.rangeSlider',
    function ($, promise, defaultInputValidationHandler, eventsInitializer, apiService, containerHelper, numericBox, rangeSlider) {
        'use strict';
        return {
            init: function (container, initData) {
                var control = {}, _$wrapper, _$controlWrapper, _toNumericBox, _fromNumericBox, _slider, _validationHandler = defaultInputValidationHandler.init(control), _events = eventsInitializer.init(control, ['onChange', 'onRemove']);
                ...
                function initInputs() {
                    ...
                    var promises = [promise1, promise1];
