    ...
    function ($, promise, defaultInputValidationHandler, eventsInitializer) {
        ...
        return {
            init: function (container, initData) {
                var control = {}, _$wrapper, _$controlWrapper, _$readOnlyWrapper, _validationHandler = defaultInputValidationHandler.init(control), _events = eventsInitializer.init(control, ['onChange', 'onRemove']);
                ...
                function setReadOnlyText() {
                    var $label = $('<span />'), $icon = $('<i class="color-indicator" />').css({
                        height: '16px',
                        width: '16px',
