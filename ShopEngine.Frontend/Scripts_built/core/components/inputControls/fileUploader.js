app.registerComponent('fileUploader', 'UI', [
    ...
    'UI.filesViewer',
    'Resources.UICore',
    function ($, promise, defaultInputValidationHandler, eventsInitializer, containerHelper, objects, urls, collections, filesViewer, resources) {
        'use strict';
        return {
            init: function (container, initData) {
                var _$wrapper, _$uploadButton, _$currentFileName, _$progressBar, _$progressBarInner, _filesViewer, _files = [];
                var _events = {
                    onChange: eventsInitializer.initVoidEvent(),
                    onRemove: eventsInitializer.initVoidEvent(),
                    onStart: eventsInitializer.initEvent(),
                    onDone: eventsInitializer.initEvent(),
                    onFail: eventsInitializer.initEvent(),
                    onProgress: eventsInitializer.initEvent()
                };
                var _control = {
                ...
                function setValue(value) {
                    ...
                    _files = [];
                    collections.foreach(value, function (file) {
                        _files.push(file);
                    });
