app.registerComponent('multiSelectList', 'UI', [
    ...
    'Services.apiService',
    function ($, promise, objects, collections, strings, eventsInitializer, defaultInputValidationHandler, apiService) {
        'use strict';
        return {
            init: function (container, initData) {
                var control = {}, _$control, _$wrapper, _valueData = [], _validationHandler = defaultInputValidationHandler.init(control), _events = eventsInitializer.init(control, ['onChange', 'onRemove']);
                ...
                function setValue(value) {
                    ...
                    var changed = false, intersection = collections.intersect(value, _valueData, function (item1, item2) {
