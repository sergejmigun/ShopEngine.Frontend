    ...
    function ($, promise, defaultInputValidationHandler, eventsInitializer) {
        ...
        return {
            init: function (container, initData) {
                var control = {}, _$wrapper, _$controlWrapper, _$readOnlyLabel, _$control, _value, _setUIValue, _validationHandler = defaultInputValidationHandler.init(control), _events = eventsInitializer.init(control, ['onChange', 'onRemove']);
                ...
                function initNullable() {
                    ...
                    var $cbTrue = _$control.find('.cb-true'), $cbFalse = _$control.find('.cb-false');
