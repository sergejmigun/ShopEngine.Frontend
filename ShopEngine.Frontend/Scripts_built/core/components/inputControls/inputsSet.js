app.registerComponent('inputsSet', 'UI', [
    ...
    'Collections',
    function ($, promise, objects, inputsSetValidationHandler, eventsInitializer, containerHelper, collections) {
        'use strict';
        return {
            init: function (container, initData) {
                var control = {}, _$wrapper, _controls = [], _validationHandler, _events = eventsInitializer.init(control, ['onChange', 'onRemove']);
