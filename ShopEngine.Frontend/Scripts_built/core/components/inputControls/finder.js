app.registerComponent('finder', 'UI', [
    ...
    'Utils.objects',
    'Collections',
    function ($, promise, resources, defaultInputValidationHandler, eventsInitializer, objects, collections) {
        'use strict';
        return {
            init: function (container, initData) {
                var control = {}, _$wrapper, _$controlWrapper, _$readOnlyLabel, _$control, _$clearInput, _valueData, _validationHandler = defaultInputValidationHandler.init(control), _events = eventsInitializer.init(control, ['onChange', 'onRemove']);
                ...
                function filterResults(resultItems) {
                ...
                function init(success) {
                    ...
                    _$control.on("select2:select", function (e) {
