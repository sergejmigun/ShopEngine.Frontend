app.registerComponent('timePicker', 'UI', [
    ...
    'Services',
    'Utils.dates',
    function (promise, objects, dates, defaultInputValidationHandler, eventsInitializer) {
        'use strict';
        return {
            init: function (container, initData) {
                var control = {}, _$wrapper, _$controlWrapper, _$readOnlyLabel, _$control, _value, _format, _validationHandler = defaultInputValidationHandler.init(control), _events = eventsInitializer.init(control, ['onChange', 'onRemove']), _fakeDate = new Date(2000, 1, 1);
                ...
                function init(success) {
                    ...
                    _$control.on("dp.onChange", function (e) {
