app.registerComponent('textBox', 'UI', [
    ...
    function ($, promise, dom, defaultInputValidationHandler, eventsInitializer) {
        'use strict';
        return {
            init: function (container, initData) {
                var control = {}, _$wrapper, _$controlWrapper, _$readOnlyLabel, _$clearInput, _$control, _value = '', _validationHandler = defaultInputValidationHandler.init(control), _events = eventsInitializer.init(control, ['onChange', 'onRemove', 'blur', 'focus']);
