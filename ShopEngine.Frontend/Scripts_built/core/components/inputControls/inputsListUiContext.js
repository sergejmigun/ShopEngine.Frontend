app.registerComponent('inputsListUiManager', 'Services', [
    ...
    function ($, promise, collections, ui, dropDownMenu, checkBox, buttons, apiService, containerHelper) {
        'use strict';
        return {
            init: function (initData) {
                var context = {}, _$wrapper, _$inputsTable, _$tableBody, _$firstGroupTableBody, _$header, _$addButtonWrapper, _$noData;
                ...
                context.initHeader = function (header) {
                    var $headerRow = $('<tr />'), $headerTd = $('<td class="inputs-list-control-cell" />');
                ...
                context.renderGroupRow = function (groupData, isFirstRow) {
                    var $tr = $('<tr class="inputs-list-item inputs-list-item-group" />'), $tdHeader = $('<td class="grouping-header" />'), $tdTitle = $('<td class="grouping-title" />'), $title = $('<h4 />'), colspan = getColspan(2, initData.selectable, initData.sortable);
                ...
                context.renderControlRow = function (controlInitializer, value, actionsData) {
                    var $tr = $('<tr class="inputs-list-item" />'), $tdActions = $('<td class="button-cell" />'), $input = $('<input type="hidden" />'), checkBoxPromise, dropDownMenuInst;
                    ...
                    function initActionsMenu(data) {
                        dropDownMenu.init(containerHelper.appendTo($tdActions, initData.containerReady), {
                            ...
                            items: collections.from(data).skip(1).toArray(),
