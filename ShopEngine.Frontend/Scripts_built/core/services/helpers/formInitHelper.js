app.registerComponent('formInitHelper', 'Services.forms', [
    ...
    function (promise, collections, templates, resourcesCore, buttons, modals, viewHelper, containerHelper, eventsInitializer, wrapperWithButtons) {
        'use strict';
        function getSubmitButtonData(templateObj, event) {
        ...
        function getCancelButtonData(templateObj, event) {
        ...
        var formInitHelper = {
            openModal: function (initData) {
                var events = {
                    onSubmit: eventsInitializer.initEvent(),
                ...
                var modalInitData = {
                    ...
                    initButtons: function ($container, modalHelper) {
                        var container = containerHelper.appendTo($container, promise.empty()), submitButtonData = getSubmitButtonData(modalHelper, events.onSubmit), cancelButtonData = getCancelButtonData(modalHelper, events.onCancel), submitButtonInitAction = submitButtonData.action, cancelButtonInitAction = cancelButtonData.action;
