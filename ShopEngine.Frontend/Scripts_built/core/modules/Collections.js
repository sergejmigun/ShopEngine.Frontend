app.registerModule('Collections', ['$', 'Lib.objects.enumerable', function ($, enumerable) {
        'use strict';
        function getArrayEumeration(elementsSet) {
            if (!elementsSet) {
                elementsSet = [];
            }
        ...
        function getObjectEnumeration(elementsSet) {
            if (!elementsSet) {
                elementsSet = {};
            }
            return enumerable.init(function (onIterate) {
                var keys = Object.keys(elementsSet), falseIteration;
        ...
        return {
            module: {
                from: function (elementsSet) {
                    return getArrayEumeration(elementsSet);
                },
                fromObject: function (elementsSet) {
                    return getObjectEnumeration(elementsSet);
                },
                ...
                groupBy: function (array, keySelector) {
                    ...
                    self.safeForeach(array, function (arrayItem) {
                        var key = keySelector(arrayItem), group = self.first(groups, function (groupItem) {
                ...
                mergeObjectArrays: function (array1, array2) {
                    ...
                    var array1IncludedIndexes = {}, module = this;
                    module.foreach(array2, function (array2Item) {
