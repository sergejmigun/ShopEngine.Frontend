app.registerComponent('objects', 'Utils', [
    ...
    'Lib',
    'Collections',
    function ($, lib, collections) {
        'use strict';
        return {
            event: function () {
                return lib.objects.event.init();
            },
            addEventsHandler: function (events, handler) {
            ...
            getLocalizedText: function (localizedValue, language) {
                ...
                return collections.from(localizedValue).where(function (localizedValueItem) {
            ...
            allAreTrue: function () {
                return collections.from(arguments).all(function (arg) {
                    return !!arg;
                });
            },
            setValue: function (obj, path, value) {
                var self = this, pathParts = path.split('.'), targetObj = obj;
