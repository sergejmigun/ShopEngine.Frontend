    ...
    function ($, shared) {
        ...
        var dom = {
            ...
            cutOuterHtml: function ($container) {
                var $parent = $container.parent(), html = $parent.html();
                $parent.html('');
                return html;
            },
            ...
            insertAtCursor: function (fieldControl, value) {
                ...
                if (shared.document.selection) {
                    ...
                    // MOZILLA and othres
                    var startPos = fieldControl.selectionStart, endPos = fieldControl.selectionEnd;
            ...
            removeCssProperty: function ($el, cssProp) {
                var styles = {}, styleStr = $el.attr('style');
