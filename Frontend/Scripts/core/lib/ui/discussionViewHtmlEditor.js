        ...
        return {
            init: function ($inputWrapper, commentData, _initData) {
                ...
                function initTinyMce(success) {
                    var textAreaId = objects.getGuid(),
                    ...
                    function initPlaceholder(editor) {
                        ...
                        var $placeholder = $('<span class="discussion-placeholder" />').hide(),
                            placeholder = _initData.inputPlaceholder || 'Leave a comment';
                        ...
                        setup: function (editor) {
                            ...
                            editor.on('paste', function (ev) {
                                ...
                                var originalEvent = ev.originalEvent || ev,
                                    clipboardData = originalEvent.clipboardData || shared.window.clipboardData,
