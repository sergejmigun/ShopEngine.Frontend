    ...
    function (promise: IPromise,
        ...
        return {
            init: function (container, initData) {
                var service = {} as Services.Initialization.IGridInitializer,
                    _cellsInitializers: ((rowData: any, row: Services.Initialization.IGridRow, index: number) => any)[];
        ...
        } as Services.Initialization.IGridInitializerFactory;
    }
]);