app.registerComponent('apiService', 'Services', [
    ...
    function ($: JQueryStatic,
        ...
        errorViewer: Components.Common.IErrorViewerFactory,
        shared) {
        'use strict';

        function logError(errorData) {
            var responseData = errorData.responseJSON,
                modalHelper = services.modalHelper as Services.IModalHelper,
                componentInitializationHelper = services.componentInitializationHelper as Services.Initialization.IComponentInitializationHelper;
        ...
        var service = {
            ...
            getTemplateHtml: function (templateName, area) {
                var self = this,
                    baseUrl = '/Content/Templates/',
                    templatesStorage = shared.context.templatesStorage,
                    templateId = strings.format('{0}_{1}', templateName, area || '');
        ...
        return service as Services.IApiService;
    }
]);