app.registerComponent('wrapperWithButtons', 'Components', [
    ...
    function($: JQueryStatic,
        ...
        return {
            init: function(model, container) {
                var _$html,
                    _innerTemplate,
                    _$buttonsContainer,
                    _formButtons = [] as UI.IButton[],
                    _$bodyContainer;

                var _component: Components.Common.IWrapperWithButtons<any, any, any> = {
                ...
                function init(success) {
                    ...
                    var innerTemplateContainer = containerHelper.appendTo(_$bodyContainer, container.ready()),
                        _setContent = innerTemplateContainer.setContent;
        ...
        } as Components.Common.IWrapperWithButtonsFactory;
    }
]);