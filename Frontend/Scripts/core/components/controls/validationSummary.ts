app.registerComponent('validationSummary', 'UI', [
    ...
    return {
        init: function (container, initData) {
            var control = {} as UI.IValidationSummary,
                errors = [],
                $wrapper = $('<div class="validation-summary" />').hide();
            ...
            function addUiElement(controlErrorData) {
                var $element = $('<div class="validation-summary-item" />'),
                    $elementWrapper = $('<div class="padding-5" />');
    ...
    } as UI.IValidationSummaryFactory;
}]);