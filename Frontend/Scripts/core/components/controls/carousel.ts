    ...
    function ($: JQueryStatic,
        ...
        return {
            init: function (container, initData) {
                var control = {} as UI.ICarousel,
                    _$wrapper = $('<div class="carousel-wrapper"></div>'),
                    _events = eventsInitializer.init(control, ['movingStart', 'movingEnd']),
                    _items = [];

                function create$item(item: UI.ICarouselItem) {
                ...
                function appendItem(item: UI.ICarouselItem) {
                    _items.push(item);
