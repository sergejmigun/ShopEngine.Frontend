    ...
    function ($: JQueryStatic,
        ...
        return {
            init: function (container, initData) {
                var _$wrapper = $('<div class="tabs-wrapper" />'),
                    _$headersWrapper = $('<ul class="nav nav-tabs" />'),
                    _$contentsWrapper = $('<div class="tabs-contents-wrapper" />'),
                    _activeTabData,
                    _tabsData = [];

                var _events = {
                    onTabChanged: eventsInitializer.initEvent<UI.ITab>(),
                    onTabInit: eventsInitializer.initEvent<UI.ITab>()
                };

                var control: UI.ITabs = {
                ...
                function initTab(tab: UI.ITab, index: number) {
                    var $tabHeader = $('<li />'),
                        $tabLink = $('<a href="#" />'),
                        $contentWrapper = $('<div />'),
                        tabData = {
