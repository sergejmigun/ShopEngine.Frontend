    ...
    function($: JQueryStatic,
        ...
        return {
            init: function(container, initData) {
                var control = {} as UI.IFilesViewer,
                    _filesData = [],
                    _mode,
                    _addFileFunc,
                    _$wrapper = $('<div class="files-viewer-container" />');
                ...
                function initDeleteAction($container, fileData, isDefaultAction) {
                    var $button = getActionButton('fa-times', 'Delete file'),
                ...
                function initTilesView(files) {
                    ...
                    function initInfoAndActions(fileData, $infoButon) {
                        var $infoContainer = $('<div />'),
                            $actionsContainer = $('<div class="text-center" />');
                    ...
                    function renderFile(file) {
                        var $fileWrapper = $('<li class="file-wrapper">'),
                            $fileAction = $('<a />'),
                            $fileIcon = getFileTypeIcon(file.fileName),
                            $fileName = $('<span class="fileName file-name" />'),
                            $infoButon = $('<span class="info-button">...</span>');
                ...
                function initListView(files: UI.IFileData[]) {
                    var $listViewWrapper = $('<ul class="file-list-view-container list-group filesViewContainer" />');

                    function renderFile(file: UI.IFileData) {
                        var $fileWrapper = $('<li class="file-wrapper list-group-item" />'),
                            $fileIcon = getFileTypeIcon(file.fileName),
                            $fileName = $('<a />'),
                            $fileSize = $('<span class="file-size" />'),
                            $fileActions = $('<span class="file-actions" />');
