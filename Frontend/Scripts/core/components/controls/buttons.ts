app.registerComponent('buttons', 'UI', [
    ...
    function ($: JQueryStatic,
        ...
        function getControlButton($button, action, hidden, disabled, setTextFunc?, setIconFunc?) {
            ...
            return controlButton as UI.IButton;
        }

        function initButton(defaults, initData: UI.IButtonInitData, container: IContainer) {
            defaults.size = 'sm';
            defaults.element = '<button type="submit" />';

            var element = initData.element || defaults.element,
                size = initData.size || defaults.size,
                type = initData.type || defaults.type,
                iconCss = initData.iconCss || defaults.iconCss,
                text = initData.text || defaults.text,
                $text = $('<span />').text(text),
                $icon,
                $button = $(element);
        ...
        function getDefaults(buttonType: UI.ButtonType) {
            switch (buttonType) {
        ...
        function initRoundButton(content, initData: UI.IRoundButtonInitData, container: IContainer) {
            var $button = $('<span />'),
                $a = $('<a />');
        ...
        function initLinkButton(container, initData: UI.IButtonInitData) {
        ...
        return {
            ...
            getData: function (buttonType, initData) {
                var defaults = objects.clone(getDefaults(buttonType as UI.ButtonType))
