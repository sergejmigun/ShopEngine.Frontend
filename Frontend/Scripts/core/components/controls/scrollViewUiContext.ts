    ...
    function (
        ...
        return {
            init: function ($container, initData) {
                var context = {} as Services.ScrollView.IScrollViewUiContext,
                    _$wrapper = $('<div class="scroll-wrapper" />'),
                    _$olderDataActions,
                    _$newerDataActions,
                    _events = eventsInitializer.init(context, ['onContentChanged']);
                ...
                context.initInfiniteScroll = function (onScroll) {
                    ...
                    $p.on("scroll", function () {
                        var topOffset = $p.scrollTop(),
                            bottomOffset = $p[0].scrollHeight - $p.height() - topOffset;
        ...
        } as Services.ScrollView.IScrollViewUiContextFactory;
    }
]);