app.registerComponent('progressBar', 'UI', [
    ...
    return {
        init: function (container, initData) {
            var control = {} as UI.IProgressBar,
                _$wrapper = $('<div class="progress-bar-wrapper" />'),
                _$valueWrapper = $('<div class="progress-value" />'),
                _$progressBarContainer = $('<div class="progress-bar-inner" />'),
                _$progressBarStatus = $('<div class="progress-bar-status" />')
            ...
            function setData(data: UI.IProgressBarData) {
