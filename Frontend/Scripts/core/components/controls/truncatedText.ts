    ...
    function ($: JQueryStatic,
        ...
        return {
            init: function (container, initData) {
                var control = {} as UI.ITruncatedText;

                function init(success) {
                    var $el = $('<div class="truncated-text-wrapper" />'),
                        $inlineSpan = $('<span class="truncated-text-inline" />'),
                        $innerSpan = $('<span />').text(initData.text);
