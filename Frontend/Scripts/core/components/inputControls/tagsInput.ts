    ...
    function ($: JQueryStatic,
        ...
        return {
            init: function (container, initData) {
                var control = {} as UI.ITagsInput,
                    _$wrapper: JQuery,
                    _$tagsWrapper: JQuery,
                    _$inputwrapper: JQuery,
                    _inputControl: UI.IInputControl<any>,
                    _tagsData = [],
                ...
                function initTag(targetTagData) {
                    ...
                    var tagData = {} as any,
                        $tagWrapper = $('<div class="tag-wrapper" />'),
                        $removeButton = $('<i class="glyphicon glyphicon-remove-circle tag-remove-button"></i>');
