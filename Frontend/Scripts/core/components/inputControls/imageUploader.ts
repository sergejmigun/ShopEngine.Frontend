app.registerComponent('imageUploader', 'UI', [
    ...
    function ($: JQueryStatic,
        ...
        imageGallery: UI.IImageGalleryFactory,
        ...
        return {
            init: function (container, initData) {
                var _$wrapper: JQuery,
                    _$uploaderWrapper = $('<div class="file-uploader-wrapper" />').hide(),
                    _$imagesList = $('<div class="uploader-imagelist" />').hide(),
                    _$removeButtons: JQuery[] = [],
                    _fileUploaderInstance: UI.IFileUploader,
                    _carouselInstance: UI.ICarousel,
                    _carouselMoving = false,
                    _popovers: UI.IPopover[] = [],
                    _value = [];
                ...
                var _control: UI.IImageUploader = {
                ...
                function getCarouselItem(imageItem) {
                    ...
                    var $popoverContent = $('<div class="padding-10 text-center" />'),
                        $downloadButton = $('<a class="btn btn-success btn-xs margin-r-10" />').text(resources.download),
                        $removeButton = $('<button class="btn btn-danger btn-xs margin-r-10" />').text(resources.remove),
                        $viewButton = $('<a type="button" class="btn btn-success btn-xs" />').text(resources.view);
