app.registerComponent('autoCompleter', 'UI', [
    ...
    'Services',
    'Utils.objects',
    function ($: JQueryStatic, promise: IPromise, services, objects: Utils.IObjects) {
        'use strict';

        return {
            init: function (container, initData) {
                var control = {} as UI.IAutoCompleter,
                    _$wrapper,
                    _$controlWrapper,
                    _$readOnlyLabel,
                    _$control,
                    ...
                    _validationHandler = services.defaultInputValidationHandler.init(control),
                    _events = services.eventsInitializer.init(control, ['onChange', 'onRemove']);
