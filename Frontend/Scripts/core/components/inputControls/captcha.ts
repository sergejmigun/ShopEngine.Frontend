    ...
    function ($: JQueryStatic,
        ...
        return {
            init: function (container, initData) {
                var control = {} as UI.ICaptcha,
                    _$wrapper: JQuery,
                    _recaptchaId,
                    _value: string,
                    _scriptSrc = 'https://www.google.com/recaptcha/api.js?onload=recaptchaOnloadCallback&render=explicit',
                    _scriptHtml = '<script src="' + _scriptSrc + '" async defer />',
