app.registerComponent('inputsList', 'UI', [
    ...
    function (promise: IPromise,
        ...
        inputsListValidationHandler: Services.ValidationHandlers.IInputsListValidationHandlerFactory,
        buttons: UI.IButtonsFactory,
        uiContext: Services.InputsList.IInputsListContextFactory) {
        'use strict';

        return {
            init: function (container, initData) {
                var control = {} as UI.IInputsList<any>,
                    _ui: Services.InputsList.IInputsListContext,
                    _addButton: UI.IButton,
                    _initData = objects.clone(initData),
                    _validationHandler,
                    _controlContext,
                    _disabled,
                    _readOnly,
                    _eventNames = ['onChange', 'onRemove', 'orderChanged', 'controlRemoved', 'onSelectionChange'],
                    _events = eventsInitializer.init(control, _eventNames);
                ...
                function setDisabled(disabled) {
                    ...
                    collections.foreach(_controlContext.getControlsData(), function (controlData: any) {
                ...
                function initControlData(valueItem, source, isNewItem) {
                    function getActionsData(controlData, definedActionsData) {
                        ...
                        collections.safeForeach(definedActionsData, function (actionData) {
                            var btnData = objects.clone(actionData) as any,
                                btnAction = btnData.action;
                    ...
                    var controlUiData = _ui.renderControlRow(_initData.controlInitializer, controlValue, actionsData) as any;
                ...
                function initGroupedContext() {
                    ...
                    function renderGroupRow(groupData) {
                        ...
                        var renderGroupResult = _ui.renderGroupRow(groupData, contextData.length === 0) as any;
                    ...
                    function removeGroup(groupData) {
                        ...
                        collections.foreach(groupData.controlsData, function (controlData: any) {
                            controlData.remove();
                        });
                    }
                    ...
                    context.setValue = function (value) {
                        var toBeRemovedGroups = collections.from(contextData).where(function (groupData) {
                            return !collections.from(value).any(function (valueGroup: any) {
                        ...
                        collections.foreach(value, function (valueGroup: any, index) {
                    ...
                    context.getValue = function () {
                        return collections.from(contextData).select(function (groupData) {
                            ...
                            groupValue.items = collections.from(groupData.controlsData).select(function (controlData: any) {
                    ...
                    context.getSelectedIndexes = function () {
                        ...
                        collections.foreach(contextData, function (groupData) {
                            ...
                            collections.foreach(groupData.controlsData, function (controlData: any, index) {
                    ...
                    context.sortItems = function (oldIndex, newIndex) {
                        if (oldIndex !== newIndex) {
                            ...
                            var oldArrayData = getControlDataArray(oldIndex),
                                controlData = oldArrayData.array[oldArrayData.index];
                ...
                function init(success) {
                    var uiContextData = _initData as Services.InputsList.IInputsListContextInitData;
                ...
                control.getAllControls = function () {
                    return collections.from(_controlContext.getControlsData()).select(function (controlData: any) {
