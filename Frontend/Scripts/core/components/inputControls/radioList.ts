    ...
    function ($: JQueryStatic,
        ...
        return {
            init: function (container, initData) {
                var control = {} as UI.IRadioList,
                    _$wrapper: JQuery,
                    _$inputWrapper: JQuery,
                    _$readOnlyLabel: JQuery,
                    _inputsData = [],
                    _value: UI.ISelectListItem,
                ...
                function initItems() {
                    ...
                    function initInlineMarkup() {
                        collections.foreach(initData.items, function (item, i) {
                            var $label = $('<label class="radio-inline" />'),
                                $radioInput = $('<input type="radio" />').attr('name', radioId);
                    ...
                    function initVerticalMarkup() {
                        collections.foreach(initData.items, function (item, i) {
                            var $itemWrapper = $('<div class="radio" />'),
                                $label = $('<label />'),
                                $radioInput = $('<input type="radio" />').attr('name', radioId);
